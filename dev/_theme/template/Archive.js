...
exports.default = function(props) {
    ...
    posts.forEach(function(_ref, index) {
        ...
        if (year !== publishYear) {
            year = publishYear;
            entryList.push(_react2.default.createElement('a', {
                className: 'item-year',
                href: '#' + publishYear,
                key: publishYear,
                id: publishYear
        ...
        entryList.push(_react2.default.createElement('div', {
            className: 'item',
            key: index
        }, _react2.default.createElement('h2', {
            className: 'item-title',
            id: meta.title
        }, _react2.default.createElement('time', null, meta.publishDate.slice(0, 10) + ' '), _react2.default.createElement(_router.Link, {
    ...
    }, _react2.default.createElement(_Layout2.default, props, _react2.default.createElement('h1', {
        className: 'entry-title'
    }, 'Archive111'), _react2.default.createElement('div', {
